"""Authentication & authorization utilities (JWT + bcrypt + TOTP + BOT_API_KEY)."""
...
def get_current_admin(
    ...
    Also accepts X-BOT-KEY header for Telegram bot service calls."""
    ...
    # Check X-BOT-KEY header first (bot service calls)
    bot_key = (request.headers.get("X-BOT-KEY") or "").strip()
    if bot_key and BOT_API_KEY and bot_key == BOT_API_KEY:
