...
// Use same host as page (localhost or 127.0.0.1) so fetch works regardless of how user opened the app
var _apiHost = (typeof window !== "undefined" && window.location && window.location.hostname) ? window.location.hostname : "";
var BASE_URL = _apiHost ? "http://" + _apiHost + ":8002" : "http://127.0.0.1:8002";
...
async function sendEmailOtp(tempToken) {
